...
- `assets/site.css`, `assets/site.js` — 공통 스타일·스크립트 (travelpass 레포의 `app/tp.css`, `lib/tp.ts` 와 동기화)
- `assets/app/` — 앱 스크린샷 (`wallet` `pay` `travel` `living` `transit` `step-1~3` `step3-1-apply-1` .webp)
